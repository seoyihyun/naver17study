...
public class Ex9Argument {
	...
	public static void main(String[] args) {
		 ...
		 * 를 읽어서 위의 데이터와 입사시험의 총 합계(total)과 평균(average, 소수점 첫째자리까지만, printf 사용)를 출력하시오
		 * 
		 */
		...
		int score1=Integer.parseInt(args[3]);//String을 int로 변경
		...
		System.out.println("입사시험 총 합계:"+total+"점");
		System.out.printf("입사시험 평균:"+"%2.2f점\n",average);
